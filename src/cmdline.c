/*
  ...
  gengetopt --default-optional --conf-parser --unamed-opts=SCRIPT --strict-hidden
...
const char *gengetopt_args_info_usage = "Usage: " CMDLINE_PARSER_PACKAGE " [OPTION]... [SCRIPT]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -r, --resume-last-lesson     resume from last lesson  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->resume_last_lesson_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->resume_last_lesson_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->resume_last_lesson_help = gengetopt_args_info_help[19] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->resume_last_lesson_given)
    write_into_file(outfile, "resume-last-lesson", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "resume-last-lesson",	0, NULL, 'r' },
        { 0,  0, 0, 0 }
      };

      c = getopt_long (argc, argv, "hVbe:ntf:c:sql:wkiaSr", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'S':	/* do not ask confirmation questions.  */
          ...
          break;
        case 'r':	/* resume from last lesson.  */
        
        
          if (update_arg((void *)&(args_info->resume_last_lesson_flag), 0, &(args_info->resume_last_lesson_given),
              &(local_args_info.resume_last_lesson_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "resume-last-lesson", 'r',
              additional_error))
            goto failure;
